...
const SERVICE_ACCOUNT_PATHS: Record<Environment, string> = {
  development: resolve(
    __dirname,
    '../../scripts/service-account.development.json'
  ),
  staging: resolve(__dirname, '../../scripts/service-account.staging.json'),
  production: resolve(__dirname, '../../scripts/service-account.json'),
};
